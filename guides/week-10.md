...
> 🌟 **Susan's Week 10 Goal**: "Thunder loves being handled and sees grooming tools as predictors of good things, not threats."

---

## 📅 Weekly Structure

### 🏠 **Nanny Days (M/W/Th/F) - Grooming Focus**
...
1. **Potty Success** → Classical conditioning reinforcement
2. **Mock Grooming Session**: 
   - Stand on elevated surface (books/box) → treats
   - Brief blow dryer sound → treats throughout
   - Collar hold + gentle restraint → treats
3. **Name Game Advancement**: "Thunder" from different rooms
4. **Carrier Game**: In → treats → out → play → repeat 3x
...
### 🏙️ **Weekend Adventures - Advanced Urban Exposure**
...
1. **Enter grooming salon** → immediate treat party
2. **Table conditioning**: Lifted onto table → continuous treats
3. **Tool exposure**: Clippers off → treats, clippers on distant → treats
4. **Mock handling**: Groomer touches paws → treats
5. **Success celebration**: Leave with jackpot rewards

**11:30am - Valencia Street Café Culture:**
1. **Outdoor café sitting**: Thunder in carrier, order coffee
2. **Advanced people watching**: Different demographics + treat pairing
3. **Sound layering**: Conversation + traffic + music + treats
4. **"Settle" cue development**: Calm behavior → continuous rewards
...
2. **Dog observation training**: See dog → "Look at that" → treat
...
2. **Hair Dryer**: Sound at distance → gradually closer + treats
...
## 🔗 Grooming Professional Resources
