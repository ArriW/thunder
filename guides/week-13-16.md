...
- [Crate Training Guide]({{ "/crate-training/" | relative_url }}) — Maintain crate routine post-boarding
- [Command Vocabulary]({{ "/command-vocabulary/" | relative_url }}) — Keep cues consistent across trainers
